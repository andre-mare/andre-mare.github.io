...
If your perferred network is missing, note that you can always [follow the steps to add custom icons](advanced.md#adding-a-custom-social-media-icon) from the docs, which is what I did for this release.
...
I've added a chapter on how to [Deploy](deploy.md){:.heading.flip-title} and updated many of the existing chapters.
...
For detail, check out the new [Deploy](deploy.md){:.heading.flip-title} chapter.
...
You can include the tracking scripts by [adding them as custom HTML](basics.md#adding-custom-html-to-the-head).
