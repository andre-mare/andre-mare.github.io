...
Good images are key to making the most out of content cards. For that reason, a [chapter on images](basics.md#adding-images) has been added to the documentation.
